namespace FluentScheduler.Tests.TestApplication
{
    ...
    public class MyRegistry : Registry
    {
        ...
        private void Parameter()
        {
            ...
            Schedule(new ParameterJob { Parameter = "Foo" }).WithName("[parameter]").ToRunOnceAt(DateTime.Now.AddSeconds(10)).AndEvery(10).Seconds();
        }

        private void Disposable()
        {
            Schedule<DisposableJob>().WithName("[disposable]").ToRunOnceIn(10).Seconds();
            //Schedule<DisposableJob>().WithName("[disposable]").ToRunOnceAt(DateTime.Now.AddSeconds(10)).AndEvery(10).Seconds();
        }
